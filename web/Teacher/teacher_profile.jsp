...
<%@page import="Global.Model.ProfileInfoBundle, Global.Model.Teacher_Info;" %>


<jsp:scriptlet>
ProfileInfoBundle pib=(ProfileInfoBundle)session.getAttribute("user");
Teacher_Info ti=(Teacher_Info)pib.getUser_specific();
...
<%= pib.getAddress() %></textarea>
      ...
      <tr>
		...
		<form action="teacher_advance_info_update_action.php" method="post" >
		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFF00">
          <!--DWLayoutTable-->
          <tr>
              ...
              <tr>
                <td width="269" height="26" valign="top"><div align="right">
                  <div align="right"><strong>Education :<br><span class="style4">
                    <input name="education" value='<%= ti.getEducation() %>' type="text" id="education" size="30" <% if(adv) { %> disabled <% } %>>
                  </span>                    </strong></div>
                  </div></td>
                      <td width="2">&nbsp;</td>
                </tr>
            ...
            <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="263" height="26"><div align="right">
                  <div align="right"><strong>Experience(in Years) :</strong><br>
                    <strong><span class="style4">
                    <input name="experience" value='<%= ti.getExperience() %>' type="text" id="experience" size="30" placeholder="In years" <% if(adv) { %> disabled <% } %>>
                    </span></strong></div>
                </div></td>
              </tr>
            </table>            </td>
...
<% if(ti.getAbout()!=null){ %><%= ti.getAbout() %><% } %></textarea>
                </strong></div></td>
              </tr>
            </table>            </td>
            <td></td>
            <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="263" height="67"><div align="right"><strong>Hobbies: <br>
                    <textarea name="hobby" cols="22" rows="3" id="hobby" placeholder="One per Line" <% if(adv) { %> disabled <% } %>></textarea>
                </strong></div></td>
              </tr>
            </table>            </td>
            <td></td>
          ...
          <tr>
            ...
            <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="271" height="80"><div align="right"><strong>Subjects You Teach : <br>
                    <textarea name="subject" cols="22" rows="3" id="subject" placeholder="One per Line" <% if(adv) { %> disabled <% } %>>
<% if(ti.getSubjects()!=null){ %><%= ti.getSubjects() %><% } %></textarea>
                </strong></div></td>
              </tr>
            </table>            </td>
            <td></td>
            <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <!--DWLayoutTable-->
              <tr>
                <td width="263" height="80"><div align="right"><strong>Previous Schools  : <br>
                    <textarea name="past_school" cols="22" rows="3" id="past_school" placeholder="One per Line" <% if(adv) { %> disabled <% } %>></textarea>
                </strong></div></td>
              </tr>
            </table>            </td>
            <td></td>
            ...
            <td valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td width="263" height="29"><div align="right">
                  <input name="Cancel2" type="button" id="Cancel2" value="Cancel">
  &nbsp;
  <input name="update2" type="submit" id="update2" value="Update Info">
                </div></td>
              </tr>
            </table>
            </td>
