...
<table width="500" border="0" cellpadding="0" cellspacing="0" class="table">
  <!--DWLayoutTable-->
  <tr>
      <td width="246" height="52" valign="top"><div align="center"><em><strong><span class="style12">Teacher At </span></strong></em><strong><span class="style22"><%=pib.getSchool() %></span></strong></div></td>
